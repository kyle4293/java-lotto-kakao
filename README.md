...
3. 구매 장수 계산에 대한 테스트를 작성한 뒤 구현한다.
4. 로또 번호 생성/정렬/중복/범위 검증에 대한 테스트를 작성한 뒤 구현한다.
5. 당첨 번호 + 보너스 볼 입력 검증 테스트를 작성한 뒤 구현한다.
6. 로또 한 장의 결과 판단(`LottoResult`) 테스트를 작성한 뒤 구현한다.
7. 여러 장 집계/총 당첨금/수익률 계산 테스트를 작성한 뒤 구현한다.
